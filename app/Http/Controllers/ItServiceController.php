...
class ItServiceController extends Controller
{
    ...
    public const SERVICES = [
        ...
        ['name' => 'Contratos sob Demanda', 'icon' => 'heroicon-o-document-text', 'description' => 'Valor mensal fixo dimensionado para a administração completa do seu ambiente tecnológico.'],
