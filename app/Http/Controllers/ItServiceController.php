...
class ItServiceController extends Controller
{
    ...
    public const SERVICES = [
        ...
        ['name' => 'Consultoria e Projetos de TI', 'icon' => 'heroicon-o-light-bulb', 'description' => 'Projetos de Microsoft 365, Google Workspace, virtualização, redes WiFi e DataCenter — soluções especializadas para reestruturação, migração e segurança da infraestrutura tecnológica da sua empresa.', 'anchor' => null],
    ];
