...
>
    <div class="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white shadow-xl p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center gap-4">
        <p class="text-sm text-slate-600 flex-1">
            Este site utiliza cookies estritamente necessários ao seu funcionamento (sessão e proteção de formulários) e, quando disponível, o chat de atendimento do nosso parceiro DataSac, que usa cookies próprios para manter o histórico da sua conversa. Sem rastreamento ou publicidade. Saiba mais na
