    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5 relative">
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm text-brand-200">
                ...
                <li><a href="{{ route('success-stories.index') }}" class="hover:text-white transition">Casos de Sucesso</a></li>
                ...
                <li><a href="{{ route('careers.index') }}" class="hover:text-white transition">Trabalhe Conosco</a></li>
        ...
        <div>
            ...
            <div class="flex items-center gap-3 mt-4">
                <a href="https://web.facebook.com/databitbh" target="_blank" rel="noopener" class="h-9 w-9 flex items-center justify-center rounded-full bg-brand-900 hover:bg-accent-500 transition" aria-label="Facebook">
                ...
                <a href="https://www.instagram.com/databit.oficial/" target="_blank" rel="noopener" class="h-9 w-9 flex items-center justify-center rounded-full bg-brand-900 hover:bg-accent-500 transition" aria-label="Instagram">
                ...
                <a href="https://www.linkedin.com/company/databit-tecnologia-da-informa%C3%A7%C3%A3o/" target="_blank" rel="noopener" class="h-9 w-9 flex items-center justify-center rounded-full bg-brand-900 hover:bg-accent-500 transition" aria-label="LinkedIn">
                ...
                <a href="https://www.youtube.com/channel/UC1U62hUG7LxuCn7w80AsqEw" target="_blank" rel="noopener" class="h-9 w-9 flex items-center justify-center rounded-full bg-brand-900 hover:bg-accent-500 transition" aria-label="YouTube">
