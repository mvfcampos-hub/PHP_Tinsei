<div class="hidden md:block bg-brand-950 text-brand-100 text-sm">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between h-9">
        <div class="flex items-center gap-5">
            <a href="mailto:atendimento@databit.com.br" class="inline-flex items-center gap-1.5 hover:text-white transition">
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="#" class="hidden lg:inline hover:text-white transition">Área do Cliente</a>
