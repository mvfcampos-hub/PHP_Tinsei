...
@section('content')
    ...
    <section class="bg-brand-700">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
            ...
            <a href="https://wa.me/5531997278589?text={{ urlencode('Olá! Estou com uma dúvida sobre: '.$article->title) }}" target="_blank" rel="noopener" class="shrink-0 inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-sm font-semibold text-brand-700 hover:bg-brand-50 transition">
                Falar com o suporte
            </a>
        </div>
    </section>
