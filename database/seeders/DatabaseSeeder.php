...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedProducts(): void
    {
        ...
        $dataCountDescription = '<p>O DataCount é a solução de monitoramento de ativos de impressão e notebooks da Databit. Faça a gestão e o monitoramento do parque de equipamentos, controle o nível de suprimentos, receba alertas de equipamentos e importe medidores para faturamento — 100% integrado ao ERP DataClassic.</p>'
            .'<p>O grande diferencial do DataCount é a integração nativa com o DataClassic: os contadores de faturamento são importados automaticamente para o ERP, e a requisição de suprimentos é gerada com base no nível de suprimentos monitorado — sem planilhas paralelas e sem digitação manual.</p>';

        $dataCountHighlights = [
            ['icon' => 'M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0110.56 0m-10.56 0L6.34 18m10.94-4.171c.24.03.48.062.72.096m-.72-.096L17.66 18m0 0l.229 2.523a1.125 1.125 0 01-1.12 1.227H7.231c-.662 0-1.18-.568-1.12-1.227L6.34 18m11.318 0h1.091A2.25 2.25 0 0021 15.75V9.456c0-1.081-.768-2.017-1.837-2.185a48.554 48.554 0 00-1.913-.247M6.34 18H5.25A2.25 2.25 0 013 15.75V9.456c0-1.081.768-2.017 1.837-2.185a48.554 48.554 0 011.913-.247m10.5 0a48.536 48.536 0 00-10.5 0m10.5 0V3.375c0-.621-.504-1.125-1.125-1.125h-8.25c-.621 0-1.125.504-1.125 1.125v3.659M18 10.5h.008v.008H18V10.5zm-3 0h.008v.008H15V10.5z', 'title' => 'Gestão de ativos de impressão', 'desc' => 'Gestão e monitoramento completo do parque de impressoras e multifuncionais.'],
            ...
            ['icon' => 'M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375', 'title' => 'Controle de nível de suprimentos', 'desc' => 'Monitoramento do nível de toner e outros suprimentos de cada equipamento.'],
            ['icon' => 'M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z', 'title' => 'Alertas de equipamentos', 'desc' => 'Alertas automáticos sobre o estado e a operação dos equipamentos monitorados.'],
            ['icon' => 'M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z', 'title' => 'Medidores para faturamento', 'desc' => 'Leitura dos medidores dos equipamentos para uso direto no faturamento.'],
        ...
        $items = [
            [
                ...
                'summary' => 'ERP completo para distribuidoras, empresas atacadistas, locadoras de equipamentos, empresas de outsourcing de impressão e lojas de autopeças, com 12 módulos integrados — de cadastros e compras a fiscal, financeiro e faturamento.',
            ...
            [
                ...
                'summary' => 'Plataforma de atendimento omnichannel com automações, IA e integrações que centraliza WhatsApp, e-mail e chat em uma única caixa de entrada, com relatórios em tempo real.',
            ...
            [
                ...
                'summary' => 'Emissor de MDF-e (Manifesto de Transporte) que vincula NF-e e CT-e a uma única unidade de carga, simplificando as obrigações acessórias do transporte.',
            ...
            [
                ...
                'summary' => 'Bot e automação de atendimento por WhatsApp, com integração oficial aos sistemas Databit para comunicação com clientes direto do ERP e do atendimento.',
            ...
            [
                'name' => 'DataCount',
                'category' => 'integracoes',
                'tagline' => 'Monitoramento completo, gestão eficiente',
                'summary' => 'Monitoramento de ativos de impressão e notebooks: gestão do parque de equipamentos, controle de nível de suprimentos, alertas e medidores para faturamento — 100% integrado ao ERP DataClassic.',
