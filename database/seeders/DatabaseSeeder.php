...
<p><a href="/paginas/preparar-documentos-inscricao">Clique aqui para conferir as orientações</a></p>
...
<p><a href="/paginas/preparar-documentos-inscricao">Clique aqui</a> e veja algumas orientações para preparação dos documentos.</p>
<h3>LINK DE INSCRIÇÃO: Clique Aqui</h3>
<ul><li>Atenção, somente prossiga com o requerimento de inscrição, se você pretende atuar na área de jurisdição do CRN-9: Minas Gerais. Caso contrário, acesse o site do CRN da sua jurisdição. Clique aqui</li></ul>
<h3>OBSERVAÇÕES IMPORTANTES:</h3>
...
<p>Durante o período de teletrabalho devido à pandemia do novo Coronavírus, as visitas estão suspensas.</p>'],
            ['title' => 'Orientações para Preparação dos Documentos', 'slug' => 'preparar-documentos-inscricao', 'content' => '<p>Confira abaixo as orientações completas para preparar corretamente os documentos exigidos na sua ficha de inscrição junto ao CRN-9: assinatura digital, foto 3x4, impressão digital do polegar direito e assinaturas.</p>
<h2>Assinatura Digital - Ficha de Inscrição</h2>
<p>É possível assinar digitalmente pelo Portal gov.br: <a href="https://assinador.iti.br/assinatura/index.xhtml" target="_blank" rel="noopener">clique aqui para acessar o assinador</a>. Toda pessoa com conta prata ou ouro pode fazer a assinatura digital gratuitamente.</p>
<p>Em caso de dúvidas para assinar pela opção acima, veja as orientações a seguir:</p>
<ul><li>Alterar ou verificar o nível da sua conta gov.br (é necessário ser prata ou ouro): <a href="https://www.gov.br/governodigital/pt-br/conta-gov-br/saiba-mais-sobre-os-niveis-da-conta-govbr" target="_blank" rel="noopener">clique aqui</a>.</li><li>Tutorial oficial do gov.br para assinar o documento: <a href="https://www.gov.br/governodigital/pt-br/assinatura-eletronica" target="_blank" rel="noopener">clique aqui</a>.</li></ul>
<h2>Foto 3x4</h2>
<p>Assista ao vídeo abaixo com as orientações para tirar a foto 3x4 exigida na ficha de inscrição.</p>
<div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;max-width:100%;margin:1.5rem 0;"><iframe src="https://www.youtube.com/embed/M4wfUqod0Ow" title="Foto 3x4 - orientações para preparar seus documentos" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;border-radius:0.75rem;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy"></iframe></div>
<h2>Impressão Digital do Polegar Direito</h2>
<p>Assista ao vídeo abaixo com as orientações para coletar corretamente a impressão digital do polegar direito.</p>
<div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;max-width:100%;margin:1.5rem 0;"><iframe src="https://www.youtube.com/embed/XKLLkb2kftI" title="Impressão digital do polegar direito - orientações para preparar seus documentos" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;border-radius:0.75rem;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy"></iframe></div>
<h2>Assinaturas</h2>
<p>Assista ao vídeo abaixo com as orientações para preparar corretamente sua assinatura.</p>
<div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;max-width:100%;margin:1.5rem 0;"><iframe src="https://www.youtube.com/embed/qBur9oaxQVI" title="Assinaturas - orientações para preparar seus documentos" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;border-radius:0.75rem;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy"></iframe></div>'],
        ];
    ...
    private function seedMenu(): void
    {
        ...
        $groups = [
            ...
            [
                'label' => 'Profissional',
                'children' => [
                    ['label' => 'Serviços para Nutricionistas', 'url' => '/paginas/servicos-nutricionistas', 'section' => 'Serviços'],
                    ['label' => 'Serviços para Técnicos em Nutrição e Dietética', 'url' => '/paginas/servicos-tnd', 'section' => 'Serviços'],
                    ['label' => 'Serviços para Pessoa Jurídica', 'url' => '/paginas/servicos-pessoa-juridica', 'section' => 'Serviços'],
                    ['label' => 'Profissionais por Município', 'url' => '/profissionais-por-municipio', 'section' => 'Informações'],
            ...
            [
                'label' => 'Fiscalização',
                'children' => [
                    ['label' => 'O que é Fiscalização', 'url' => '/paginas/o-que-e-fiscalizacao', 'section' => 'Sobre a Fiscalização'],
                    ['label' => 'Como Funciona (Atividades da Fiscalização)', 'url' => '/paginas/atividades-da-fiscalizacao', 'section' => 'Sobre a Fiscalização'],
                    ['label' => 'Áreas de Atuação Fiscalizadas', 'url' => '/paginas/areas-de-atuacao-fiscalizadas', 'section' => 'Sobre a Fiscalização'],
                    ['label' => 'Responsabilidade Técnica', 'url' => '/paginas/responsabilidade-tecnica', 'section' => 'Sobre a Fiscalização'],
                    ['label' => 'Visita Fiscal (Recebi uma Fiscalização)', 'url' => '/fiscalizacao/recebi-uma-fiscalizacao', 'section' => 'Denúncias e Orientação'],
                    ['label' => 'Exercício Ilegal da Profissão', 'url' => '/paginas/exercicio-ilegal-da-profissao', 'section' => 'Denúncias e Orientação'],
                    ['label' => 'Denúncias', 'url' => '/paginas/denuncia', 'section' => 'Denúncias e Orientação'],
                    ['label' => 'Perguntas Frequentes (Fiscalização)', 'url' => '/paginas/duvidas-frequentes-fiscalizacao', 'section' => 'Denúncias e Orientação'],
                    ['label' => 'Quadro Técnico', 'url' => '/fiscalizacao', 'section' => 'Equipe e Documentos'],
                    ['label' => 'Materiais Orientativos', 'url' => '/paginas/orientacoes-online', 'section' => 'Equipe e Documentos'],
                    ['label' => 'Relatórios da Fiscalização', 'url' => '/paginas/relatorios-da-fiscalizacao', 'section' => 'Equipe e Documentos'],
                    ['label' => 'Projetos Especiais', 'url' => '/paginas/projetos-especiais-fiscalizacao', 'section' => 'Equipe e Documentos'],
                    ['label' => 'Fiscalização em Números', 'url' => '/fiscalizacao/em-numeros', 'section' => 'Dados e Processos'],
                    ['label' => 'Processos em Andamento', 'url' => '/fiscalizacao/processos', 'section' => 'Dados e Processos'],
                    ['label' => 'Política Nacional de Fiscalização', 'url' => '/paginas/politica-nacional-de-fiscalizacao', 'section' => 'Dados e Processos'],
                    ['label' => 'Visitas Técnicas', 'url' => '/paginas/visitas-tecnicas', 'section' => 'Dados e Processos'],
                ],
            ],
            [
                'label' => 'Ética',
            ...
            [
                'label' => 'Transparência',
                'children' => [
                    ['label' => 'Portal da Transparência', 'url' => 'https://crn-mg.implanta.net.br/portaltransparencia/#publico/inicio', 'external' => true, 'section' => 'Portal e Prestação de Contas'],
                    ['label' => 'Prestação de Contas', 'url' => '/paginas/prestacao-de-contas', 'section' => 'Portal e Prestação de Contas'],
                    ['label' => 'Relatórios de Gestão', 'url' => '/paginas/relatorios-de-gestao', 'section' => 'Portal e Prestação de Contas'],
                    ['label' => 'Planejamento Estratégico', 'url' => '/paginas/planejamento-estrategico', 'section' => 'Portal e Prestação de Contas'],
                    ['label' => 'Plano de Ação', 'url' => '/paginas/plano-de-acao', 'section' => 'Portal e Prestação de Contas'],
                    ['label' => 'Execução Orçamentária', 'url' => '/paginas/execucao-orcamentaria', 'section' => 'Execução Financeira'],
                    ['label' => 'Licitações e Contratos', 'url' => '/licitacoes', 'section' => 'Execução Financeira'],
                    ['label' => 'Diárias e Passagens', 'url' => '/paginas/diarias-e-passagens', 'section' => 'Execução Financeira'],
                    ['label' => 'Pessoal', 'url' => '/paginas/pessoal', 'section' => 'Execução Financeira'],
                    ['label' => 'Remuneração', 'url' => '/paginas/remuneracao', 'section' => 'Execução Financeira'],
                    ['label' => 'Dados Abertos', 'url' => '/paginas/dados-abertos', 'section' => 'Acesso à Informação'],
                    ['label' => 'Ouvidoria', 'url' => '/paginas/ouvidoria', 'section' => 'Acesso à Informação'],
                    ['label' => 'Política de Privacidade (LGPD)', 'url' => '/paginas/lgpd', 'section' => 'Acesso à Informação'],
                    ['label' => 'Política de Cookies', 'url' => '/paginas/politica-de-cookies', 'section' => 'Acesso à Informação'],
                    ['label' => 'SIC – Serviço de Informação ao Cidadão', 'url' => '/paginas/sic-servico-de-informacao-ao-cidadao', 'section' => 'Acesso à Informação'],
                ],
            ],
        ];
...
<p>A elaboração do texto dos artigos originais e submissão devem seguir os trâmites e orientações descritas no site da Revista SAN .</p>'],
            ['title' => 'Orientações para Preparação dos Documentos', 'category' => 'Institucional', 'is_featured' => false, 'excerpt' => 'Confira o passo a passo completo, com vídeos, para preparar a assinatura digital, a foto 3x4, a impressão digital e as assinaturas exigidas na ficha de inscrição.', 'image' => null, 'body' => '<p>O CRN-9 preparou um guia completo — com vídeos explicativos — para ajudar você a preparar corretamente os documentos exigidos na ficha de inscrição: assinatura digital, foto 3x4, impressão digital do polegar direito e assinaturas.</p>
<p><a href="/paginas/preparar-documentos-inscricao">Confira o passo a passo completo aqui</a>.</p>'],
